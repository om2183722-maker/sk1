...
class DependencyResolver(
    ...
    private val buildSettings: ProjectSettings
) {
    companion object {
    ...
    fun resolveDependency(callback: DependencyResolverCallback) = runBlocking {
        ...
        val extractedCompileAssetsPath = File(SketchApplication.getContext().filesDir, "libs")
        val libraryJars = listOf(
            extractedCompileAssetsPath.toPath().resolve("core-lambda-stubs.jar"), Paths.get(
        ...
        val classpath = buildSettings.getValue("classpath", "")
